...
| Embeddings helpers | `Inside-Success/open_web_retrieval` | company downstream pending separate review | company overlay | retain downstream | Do not imply upstream acceptance until this capability has its own reviewed port. |
