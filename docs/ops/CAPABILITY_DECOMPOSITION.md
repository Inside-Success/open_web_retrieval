...
| Reddit and embeddings helpers | `Inside-Success/open_web_retrieval` | company downstream pending separate review | company overlay | retain downstream | Do not imply upstream acceptance until each capability has its own reviewed port. |
